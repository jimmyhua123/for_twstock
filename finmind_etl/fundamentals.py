"""Fetch fundamental datasets required by the pipeline."""
...
def fetch_fundamental_data(
    ...
    for spec in iter_category_specs("fundamental"):
        LOGGER.info("抓取基本面資料：dataset=%s", spec.name)
        results[spec.name] = _fetch_dataset(client, spec, options)

    return results


__all__ = ["fetch_fundamental_data"]
